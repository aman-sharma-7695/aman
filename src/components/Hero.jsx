...
const Hero = () => {
  ...
  return (
    <div className='bg-dark-black relative' id='home'>
      ...
      <div className='max-w-[1240px] relative z-10 mx-auto px-5 md:px-6 py-[42px] grid grid-cols-1 md:grid-cols-2 gap-8'>
        <div className='flex flex-col justify-center  items-start  md:text-left' data-aos="fade-up-right" >
          ...
          <div className='flex flex-row gap-5 md:gap-8'>
            <button className='bg-fed-orange hover:bg-orange-700 duration-700 text-white text-sm md:text-lg font-normal px-3 py-2 md:px-6 lg:px-12 xl:px-12   md:py-3 lg:py-[17px] rounded-custom-xl' data-aos="fade-up-left">Hire Me</button>
            <button onClick={handleDownload} className='bg-fed-orange hover:bg-orange-700 transition duration-700 text-white text-sm md:text-lg font-normal px-3 py-2 md:px-6 lg:px-12 xl:px-12 md:py-4 lg:py-[17px] rounded-custom-xl' data-aos="fade-up-left">Download CV</button>
          </div>
       </div>
