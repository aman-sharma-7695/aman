    ...
    <div className='bg-dark-black ' id='home'>
      <div className='max-w-[1240px] mx-auto px-5 md:px-6 grid grid-cols-1 md:grid-cols-2 gap-8'>
        ...
        <div className="flex flex-col justify-center items-center  ">
          ...
          <div className='w-10 h-10 rounded-full bg-stone-600 hover:bg-blue-600 duration-500  flex justify-center items-center'>
              <a href="https://www.facebook.com/profile.php?id=100015111160029&mibextid=ZbWKwL">
                <FacebookIcon />
              </a>  
            </div>

            <div className='w-10 h-10 rounded-full bg-stone-600 hover:bg-black duration-500 flex justify-center items-center'>
              <a href="https://x.com/AmanSharma7695?t=nVbDOYBT3qVtx1ScjH0dpg&s=09">
                <TwiiterIcon />
              </a>
            </div>

            <div className='w-10 h-10 rounded-full bg-stone-600 hover:bg-pink-600 duration-500 flex justify-center items-center'>
              <a href="https://www.instagram.com/aman__sharma19?igsh=MTBsZzI1bWJlcHA4OA==">
                <InstagramIcon className="" />
              </a>
            </div>

            <div className='w-10 h-10 rounded-full bg-stone-600 hover:bg-sky-600 duration-500 flex justify-center items-center'>
