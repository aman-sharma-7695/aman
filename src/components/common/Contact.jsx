          ...
          <div className=' flex justify-center py-11 md:py-60 cursor-pointer '>
            <form onSubmit={inputChange} className='flex flex-col gap-5 items-center' action="">
              ...
              <input type="text"
                ...
                className='w-full h-[200px]  text-black resize-none p-2 border-[2.2px] duration-300 hover:border-fed-orange rounded-md md:rounded-custom-2xl outline-none text-sm md:text-base placeholder:text-sm md:placeholder:text-base placeholder:text-opacity-50  placeholder:font-medium'
              />
