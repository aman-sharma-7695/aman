...
const AboutMe = () => {
  ...
  return (
    <div className='bg-dark-black' id='aboutme'>
      <div className='max-w-8xl mx-auto px-4 pt-5 md:pt-20 grid grid-cols-1 md:grid-cols-2 '>
        ...
        <div className='flex flex-col lg:py-5 accents md:order-1' data-aos="fade-up"
          ...
          <div className='flex  flex-col gap-1 '>
            <h3 className='text-white text-lg lg:text-2xl pt-2 lg:pt-5 '>HTML</h3>
            <input type="range" className='w-full ' min="0"
              max="100"
              value="80" />
            <h4 className='text-white text-lg  lg:text-2xl pt-2  lg:pt-5'>CSS</h4>
            <input type="range" className='w-full' min="0"
              max="100"
              value="70" />
            <h4 className='text-white text-lg  lg:text-2xl pt-2 lg:pt-5'>JS</h4>
            <input type="range" className='w-full' />
            <h4 className='text-white text-lg  lg:text-2xl pt-2 lg:pt-5'>REACT JS WITH TAILWIND</h4>
            <input type="range" className='w-full' />
          </div>
